    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('constructor', models.ForeignKey(default=False, null=True, on_delete=django.db.models.deletion.SET_NULL, to='Guest.newconstructor')),
            ],
        ),
    ]
